...
import co.bybardo.myapp.infrastructure.networking.base.RxErrorHandlingCallAdapterFactory
...
class RetrofitManager(
    ...
    private fun provideHeaderInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            val accessToken = sessionRepository.getToken().onErrorReturnItem("").blockingGet()
