...
public final class BleOperation {
    ...
    public static BleOperation newReadOperation(UUID service, UUID charUuid, byte[] data,
            boolean highPriority) {
        return new BleOperation(service, charUuid, data, false, BleOperationType.TYPE_READ,
                highPriority);
    }
